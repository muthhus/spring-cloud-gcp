...
public class PubSubMessageChannelBinder
	...
	public PubSubMessageChannelBinder(boolean supportsHeadersNatively, String[] headersToEmbed,
			PubSubTopicProvisioner provisioningProvider) {
	...
	protected MessageHandler createProducerMessageHandler(ProducerDestination destination,
			...
			throws Exception {
		PubSubMessageHandler pubSubMessageHandler = new PubSubMessageHandler(this.pubSubTemplate);
		pubSubMessageHandler.setTopic(destination.getName());
	...
	protected MessageProducer createConsumerEndpoint(ConsumerDestination destination, String group,
		...
		return new PubSubInboundChannelAdapter(this.subscriberFactory, destination.getName());
	}
